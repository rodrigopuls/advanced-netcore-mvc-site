...
namespace BBShop.App.Extensions
{
    public static class RazorExtensions
    {
        ...
        public static string ExibeDocumentoBadge(this RazorPage page, int tipoPessoa, string documento)
        {
            return tipoPessoa == 1 ? "<span class=\"badge badge-primary\">PF</span>" : "<span class=\"badge badge-success\">PJ</span>";
        }
    }
}
